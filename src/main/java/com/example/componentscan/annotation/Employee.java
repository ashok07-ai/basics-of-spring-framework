...
/**
 * Represents an Employee entity, with fields initialized using Spring's `@Value` annotation.
 */
@Component("employee") // Marks this class as a Spring-managed component with the bean name "employee".
public class Employee {
    ...
    /**
     * Overrides the `toString` method to provide a human-readable representation of the Employee object.
     */
    @Override
